  ...
  return (
    ...
    >
      <motion.nav
        ...
        className="row-start-1 flex gap-6 items-center justify-end w-full"
      >
        <a
      ...
      >
        ...
        <ul className="list-inside list-disc text-md text-center sm:text-left text-gray-400 font-[family-name:var(--font-geist-mono)]">
          <li className="mb-2">
            A full-stack engineer from India, Bengaluru learning about AI Agents
          </li>
          <li className="mb-2">
            Building{" "}
            <a
          ...
          <li className="mb-2">
            Worked on a statup streaming statups for 8 months
          </li>
          <li className="mb-2">
        ...
        <motion.div className="">
          ...
          <ol className="list-inside list-decimal text-sm  sm:text-left font-[family-name:var(--font-geist-mono)]">
            ...
            <li className="mb-2 text-gray-400">
              ...
              LMS platform for students to learn the courses and also provide
